...
class SessionSummary {
  ...
  // Impact force metrics (from est_force_n in database)
  final double avgForceN; // N - Impact force at racket tip
  final double maxForceN; // N

  // Swing force metrics (from impact_severity in database)
  final double avgSwingForceN; // N - Swing force from racket+sensor mass
  final double maxSwingForceN; // N
  ...
  const SessionSummary({
    ...
    required this.avgSwingForceN,
    required this.maxSwingForceN,
  ...
  String toString() {
    return 'SessionSummary(sessionId: $sessionId, startTime: $startTime, '
        ...
        'avgImpactForce: $avgForceN N, avgSwingForce: $avgSwingForceN N, '
        'avgAccel: $avgAccelMs2 m/s²)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is SessionSummary &&
        ...
        other.avgSwingForceN == avgSwingForceN &&
        other.maxSwingForceN == maxSwingForceN &&
