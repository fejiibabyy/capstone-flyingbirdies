...
class _MetricGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final impactAvg = s.avgForceN; // Impact force (est_force_n)
    final impactMax = s.maxForceN;
    final accelAvg = s.avgAccelMs2;
    final accelMax = s.maxAccelMs2;

    // Swing force (impact_severity) - different from impact force
    final swingForceAvg = s.avgSwingForceN;
    final swingForceMax = s.maxSwingForceN;
